...
python nli_eval.py --model_name_or_path ${path} --type e2e ./data/e2e.tsv output_e2e.json
python nli_eval.py --model_name_or_path ${path} --type e2e --no-templates ./data/e2e.tsv output_e2e_backoff.json
